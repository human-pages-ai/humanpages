...
contract HumanPagesEscrowV2Test is Test {
    ...
    function test_attack_fee_on_transfer_underfunds_escrow() public {
        ...
        HumanPagesEscrowV2 feeEscrow = new HumanPagesEscrowV2(address(feeToken));
    ...
    function test_attack_cei_revert_rolls_back_state() public {
        ...
        assertEq(uint8(escrow.getEscrow(testJobId).state), uint8(HumanPagesEscrowV2.EscrowState.Empty));
    }
    ...
    function test_attack_cancel_accept_at_exact_expiry() public {
        ...
        assertEq(uint8(escrow.getEscrow(jobId).state), uint8(HumanPagesEscrowV2.EscrowState.Cancelled));
        assertEq(usdc.balanceOf(payee), 30e6);
    }
    ...
    function test_attack_admin_grants_self_relayer() public {
        ...
        escrow.markComplete(jobId);
        assertEq(uint8(escrow.getEscrow(jobId).state), uint8(HumanPagesEscrowV2.EscrowState.Completed));
    }
