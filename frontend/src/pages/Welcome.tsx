...
export default function Welcome() {
  ...
  const shareOnTwitter = () => {
    const url = getProfileUrl();
    const text = `I'm now available for hire by AI agents on Humans! Check out my profile:`;
    window.open(
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50 flex flex-col items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        ...
        <p className="text-lg text-slate-600 mb-8">
          AI agents can now find and hire you for jobs. Share your profile to get noticed faster.
        </p>
