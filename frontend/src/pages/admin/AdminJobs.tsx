            ...
            {loading ? (
              ...
              jobs.map((j) => (
                <tr key={j.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3 text-sm text-gray-900 max-w-xs truncate">{j.title}</td>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{j.human.name}</td>
                  <td className="px-4 py-3 text-sm text-gray-600">{j.registeredAgent?.name || j.agentName || j.agentId}</td>
