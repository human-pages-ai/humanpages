...
const SOCIAL_ICONS: Record<string, JSX.Element> = {
  ...
  Farcaster: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M18.24 0.24H5.76C2.688 0.24 0.24 2.688 0.24 5.76v12.48c0 3.072 2.448 5.52 5.52 5.52h12.48c3.072 0 5.52-2.448 5.52-5.52V5.76c0-3.072-2.448-5.52-5.52-5.52zM18.5 17.4c-0.1 0-0.2-0.08-0.2-0.18L17.2 12.6h-0.6l-1.1 4.62c-0.02 0.1-0.1 0.18-0.2 0.18h-0.02c-0.1 0-0.18-0.08-0.2-0.18L13.7 12h-3.4l-1.38 5.22c-0.02 0.1-0.1 0.18-0.2 0.18h-0.02c-0.1 0-0.18-0.08-0.2-0.18L7.4 12.6h-0.6l-1.1 4.62c-0.02 0.1-0.1 0.18-0.2 0.18h-0.02c-0.1 0-0.18-0.08-0.2-0.18l-1.5-6.24c-0.02-0.1 0.04-0.2 0.14-0.22 0.1-0.02 0.2 0.04 0.22 0.14l1.38 5.76 1.1-4.62c0.02-0.1 0.1-0.18 0.2-0.18h0.96c0.1 0 0.18 0.08 0.2 0.18l1.3 4.92 1.3-4.92c0.02-0.1 0.1-0.18 0.2-0.18h3.88c0.1 0 0.18 0.08 0.2 0.18l1.3 4.92 1.3-4.92c0.02-0.1 0.1-0.18 0.2-0.18h0.96c0.1 0 0.18 0.08 0.2 0.18l1.1 4.62 1.38-5.76c0.02-0.1 0.12-0.16 0.22-0.14 0.1 0.02 0.16 0.12 0.14 0.22l-1.5 6.24c-0.02 0.1-0.1 0.18-0.2 0.18h-0.02z" />
    </svg>
  ),
  GitHub: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
