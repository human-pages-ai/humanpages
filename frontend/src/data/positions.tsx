...
export const POSITIONS: Position[] = [
  ...
  },
  {
    ...
    tagline: 'Create visuals that communicate our brand and captivate our audience.',
    bullets: [
      'Design marketing assets, social graphics, and brand materials',
      'Develop visual identity systems and style guides',
      'Collaborate with marketing and product on creative campaigns',
    ],
    tag: 'Design',
    category: 'Creative',
  },
  ...
  },
  {
    ...
    tagline: 'Turn raw footage into stories that move people to action.',
    bullets: [
      'Edit promotional videos, demos, and social content',
